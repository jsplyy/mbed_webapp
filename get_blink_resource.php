	...
	$headers = array(
		...
		$ch = curl_init();  
		$timeout = 5;  
		curl_setopt ($ch, CURLOPT_URL, "https://api.connector.mbed.com/endpoints/".$_GET["pointid"].$_GET["blinkid"]);
	 ...
	 <body>
	 	<div class="container">
	 		<h3><img src="./img/NXP_logo.png">  Here is all the information about board LED blink</h3>
			<hr>
